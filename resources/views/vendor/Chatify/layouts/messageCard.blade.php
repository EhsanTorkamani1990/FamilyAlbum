    ...
    <div class="message-card" data-id="{{ $id }}">
        <p>{!! ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message) !!}
            ...
            <video width="200" controls>
                    <source src="{{ route(config('chatify.attachments.route'),['fileName'=>$attachment[0]]) }}" type="video/mp4">
                    <source src="{{ route(config('chatify.attachments.route'),['fileName'=>$attachment[0]]) }}" type="video/ogg">
