  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">ایا برای حذف مطمئن هستید؟</div>
              <div class="app-modal-body">!!!!</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">خیر</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">بله </a>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="app-modal" data-name="alert">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="alert" data-modal='0'>
              ...
              <div class="app-modal-body"></div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">لغو</a>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  @csrf
                  <div class="app-modal-header">پروفایل خود را به روز رسانی کنید </div>
                  <div class="app-modal-body">
                      ...
                      {{-- Dark/Light Mode  --}}
                      <p class="divider"></p>
                      <p class="app-modal-header">حالت تیره  <span class="
                        {{ Auth::user()->dark_mode > 0 ? 'fas' : 'far' }} fa-moon dark-mode-switch"
                         data-mode="{{ Auth::user()->dark_mode > 0 ? 1 : 0 }}"></span></p>
                      {{-- change messenger color  --}}
                      <p class="divider"></p>
                      <p class="app-modal-header">عوض کردن رنگ ترکمنی چت </p>
                  ...
                  <div class="app-modal-footer">
                      <a href="javascript:void(0)" class="app-btn cancel">خیر</a>
                      <input type="submit" class="app-btn a-btn-success update" value="آپلود" />
                  </div>
              </form>
          </div>
      </div>
